  ...
  return (
    <View>
      <View style={styles.top}>
        <Avatar.Image source={require('../assets/placer.png')} size={60} />
        <Text style={styles.title}>Abdullah Sad</Text>
        <Text style={styles.caption}>abdullahAlwaysSad@crying.com </Text>
